...
namespace UnitTest1
{
	...
	public:
		TEST_METHOD(Test_SplitText1)
		{
			...
			int count = Utils::SplitText(string1, ' ', &sl1, ARDJACK_MAX_VALUES, ARDJACK_MAX_VALUE_LENGTH, true);
		...
		TEST_METHOD(Test_SplitText2)
		{
			...
			int count = Utils::SplitText(string1, ' ', &sl1, ARDJACK_MAX_VALUES, ARDJACK_MAX_VALUE_LENGTH, false);
